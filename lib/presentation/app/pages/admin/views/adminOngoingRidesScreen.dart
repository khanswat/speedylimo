...
class AdminOngoingRidesScreen extends StatefulWidget {
  const AdminOngoingRidesScreen({
    Key? key,
  }) : super(key: key);

  @override
  State<AdminOngoingRidesScreen> createState() =>
      _AdminOngoingRidesScreenState();
}
